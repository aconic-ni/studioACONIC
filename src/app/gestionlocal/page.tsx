...
export default function GestionLocalPage() {
  ...
  // State for modals
  const [assignmentModal, setAssignmentModal] = useState<{ isOpen: boolean; type: 'aforador' | 'revisor' | 'bulk-aforador' | 'bulk-revisor'; worksheet?: Worksheet | null; } | null>(null);
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      const fetchedWorksheets = snapshot.docs.map(doc => ({ id: doc.id, ...doc.data() } as Worksheet));
